...
class ProductosController extends Controller
{
    ...
    {
        $productos = Producto::with(['familia', 'proveedor', 'tamanos', 'colores'])->get();
    ...
    {
        $producto = Producto::with(['familia', 'proveedor', 'tamanos', 'colores'])->findOrFail($id);
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('productos.index')->with('error', 'No se puede eliminar el producto porque tiene datos relacionados.');
        }
    }
}
