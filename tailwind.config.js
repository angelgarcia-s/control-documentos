...
export const content = [
    ...
    "./resources/**/*.scss",
    "./resources/**/*.js",
    "./vendor/laravel/framework/src/Illuminate/Pagination/resources/views/*.blade.php", // Breeze
    "./storage/framework/views/*.php", // Breeze
...
export const theme = {
    ...
    fontFamily: {
        ...
        sans: ['Figtree', ..._fontFamily.sans], // Breeze
    },
    fontSize: {
