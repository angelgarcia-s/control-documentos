        ...
        <div class="col-span-12">
            <div class="box">
                <div class="box-header">
                    <h5 class="box-title">Tipos de Sello</h5>
                </div>
                <div class="box-body space-y-3">
                    <div class="flex justify-between">
                        <div>
                            @can('tipos-sello-create')
                                <a href="{{ route('tipos-sello.create') }}" class="ti-btn ti-btn-primary px-4 py-2 rounded mb-4 inline-block">Agregar Nuevo Tipo de Sello</a>
                            @endcan
                        </div>
                        <div class="space-x-2">
                            @can('tipos-sello-import')
                                <button type="button" class="ti-btn ti-btn-primary" id="import-xlsx">Importar</button>
                            @endcan
                            @can('tipos-sello-download')
