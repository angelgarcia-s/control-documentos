        ...
        <div class="col-span-12">
            <div class="box">
                <div class="box-header">
                    <h5 class="box-title">Códigos de Barras</h5>
                </div>
                <div class="box-body space-y-3">
                    <div class="flex justify-between">
                        <div>
                            <a href="{{ route('codigos-barras.create') }}" class="ti-btn ti-btn-primary px-4 py-2 rounded mb-4 inline-block">Agregar Código de Barras</a>
                        </div>
                        <div>
