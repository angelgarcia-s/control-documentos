...
@section('content')
                      ...
                      <div class="block justify-between page-header md:flex">
                          <div>
                              <h3 class="!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.125rem] font-semibold"> Validations</h3>
                          </div>
                                  ...
                                  <div class="box-body">
                                      <form class="ti-validation">
                                          ...
                                          <div class="my-5">
                                              ...
                                              <label for="hs-checkbox-group-1" class="text-sm text-gray-500 ms-3 dark:text-[#8c9097] dark:text-white/50">I agree with the <a href="javascript:void(0);" class="text-primary hover:underline ms-1">terms and conditions</a></label>
                                          </div>
                                  ...
                                  <div class="box-body">
                                      <form class="ti-custom-validation" novalidate>
                                          ...
                                          <div class="my-5">
                                              ...
                                              <label for="hs-checkbox-group-12" class="text-sm text-gray-500 sm:ms-3 dark:text-[#8c9097] dark:text-white/50">I agree with the <a href="javascript:void(0);" class="text-primary hover:underline">terms and conditions</a></label>
                                          </div>
