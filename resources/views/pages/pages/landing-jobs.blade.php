                                        ...
                                        <div class="">
                                            ...
                                            <div class="mb-4 custom-form-group ">
                                                ...
                                                <div class="custom-form-btn">
                                                    ...
                                                    <button class="ti-btn bg-primary text-white   !font-medium !border dark:border-defaultborder/10-0" type="button"><i class="bi bi-search me-2"></i> Search</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="grid grid-cols-12 gap-6 items-center justify-center">
                                ...
                                <div class="md:col-span-7 xl:col-span-8 col-span-12">
                                    <div class="my-6">
                                        ...
                                        <a href="javascript:void(0);" class="ti-btn ti-btn-light ti-btn-lg dark:border-defaultborder/10 !font-medium"><i class="ti ti-upload"></i> Upload Your Resume</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section class="section text-defaulttextcolor text-defaultsize" id="features">
                        <div class="container">
                            ...
                            <div class="text-center">
                                <a href="javascript:void(0);" class="ti-btn ti-btn-lg bg-primary text-white !font-medium dark:border-defaultborder/10">
                        ...
                        <div class="container">
                            <div class="grid grid-cols-12 items-center justify-center">
                                ...
                                <div class="md:col-span-8 col-span-12 my-6">
                                    ...
                                    <a href="javascript:void(0);" class="ti-btn bg-primary text-white dark:border-defaultborder/10 !font-medium ti-btn-lg"><i class="ti ti-upload"></i> Publish new job</a>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="section bg-banner" id="career-advice">
                        <div class="grid grid-cols-12 justify-center !px-4">
                            ...
                            <div class="lg:col-span-6 col-span-12 text-center">
                                ...
                                <a href="javascript:void(0);" class="ti-btn ti-btn-lg ti-btn-light me-2 dark:border-defaultborder/10 !font-medium"><i class="bi bi-search me-1"></i> Search Jobs</a>
