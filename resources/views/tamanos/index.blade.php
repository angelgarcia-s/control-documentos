        ...
        <div class="col-span-12">
            <div class="box">
                <div class="box-header">
                    <h5 class="box-title">Tamaños</h5>
                </div>
                <div class="box-body space-y-3">
                    <div class="flex justify-between">
                        <div>
                            @can('tamanos-create')
                                <a href="{{ route('tamanos.create') }}" class="ti-btn ti-btn-primary px-4 py-2 rounded mb-4 inline-block">Agregar Nuevo Tamaño</a>
                            @endcan
                        </div>
                        <div class="space-x-2">
                            @can('tamanos-import')
