        ...
        <div class="col-span-12">
            <div class="box">
                <div class="box-header">
                    <h5 class="box-title">Categorías</h5>
                </div>
                <div class="box-body space-y-3">
                    <div class="flex justify-between">
                        <div>
                            @can('categorias-create')
                                <a href="{{ route('categorias.create') }}" class="ti-btn ti-btn-primary px-4 py-2 rounded mb-4 inline-block">Agregar Nueva Categoría</a>
                            @endcan
                        </div>
                        <div class="space-x-2">
                            @can('categorias-import')
                                <button type="button" class="ti-btn ti-btn-primary" id="import-xlsx">Importar</button>
                            @endcan
                            @can('categorias-download')
