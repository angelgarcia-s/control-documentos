    ...
    <div class="col-span-12">
        <div class="box">
            <div class="box-header">
                <div class="box-title">Información de {{ $user->name }}</div>
            </div>
            <div class="box-body">
            ...
            <div class="box-footer text-right">
                <a href="{{ route('usuarios.index') }}" class="ti-btn ti-btn-secondary-full mr-2">Volver</a>
                @can('editar-usuarios')
                    <a href="{{ route('usuarios.edit', $user) }}" class="ti-btn ti-btn-primary-full">Editar</a>
                @endcan
            </div>
        </div>
    </div>
