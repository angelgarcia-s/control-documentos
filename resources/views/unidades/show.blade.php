...
<div class="block justify-between page-header md:flex">
    <div>
        <h3 class="!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white text-[1.125rem] font-semibold">Detalles de la Unidad de Medida</h3>
    </div>
    <x-breadcrumbs />
</div>
<!-- Page Header Close -->
            ...
            <div class="box-body">
                <div class="grid grid-cols-12 sm:gap-x-6 sm:gap-y-4">
                    <div class="md:col-span-1 col-span-12 mb-4">
                        ...
                        <p class="form-control border border-slate-200 min-h-9">{{ $unidad->id }}</p>
                    </div>
                    <div class="md:col-span-4 col-span-12 mb-4">
                        <label class="form-label">Nombre</label>
                        <p class="form-control border border-slate-200 min-h-9">{{ $unidad->nombre }}</p>
                    </div>
                </div>
