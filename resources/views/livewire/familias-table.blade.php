                    ...
                    <tr class="border-b hover:bg-gray-100 dark:hover:bg-gray-800">
                        ...
                        <td class="py-3 px-6 border">
                            <div class="flex items-center space-x-2">
                                @can('familias-show')
                                    <a href="{{ route('familias.show', $familia) }}" class="ti-btn text-lg text-slate-400 !py-1 !px-1 ti-btn-wave">
                                        <i class="ri-eye-line"></i>
                                    </a>
                                @endcan
                                @can('familias-edit')
                                    <a href="{{ route('familias.edit', $familia) }}" class="ti-btn text-lg text-slate-400 !py-1 !px-1 ti-btn-wave">
                                        <i class="ri-pencil-line"></i>
                                    </a>
                                @endcan
                                @can('familias-destroy')
                                    <button wire:click="confirmarEliminar({{ $familia->id }})" class="ti-btn text-lg text-rose-400 !py-1 !px-1 ti-btn-wave">
