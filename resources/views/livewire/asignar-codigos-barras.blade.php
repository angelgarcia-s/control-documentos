                            ...
                            <tbody>
                                @foreach ($codigosAsignados as $codigo)
                                    <tr class="border-b border-defaultborder">
                                        ...
                                        <td>
                                            <button type="button" wire:click="confirmarDesasignacion({{ $codigo->id }})" class="ti-btn !py-1 !px-2 !text-[1rem] text-red btn-wave">
                                                <i class="ri-link-unlink align-middle"></i>
                                            </button>
                                        </td>
                                    </tr>
                                @endforeach
