                                ...
                                <ul class="slide-menu child1">
                                    ...
                                    <li class="slide has-sub">
                                        ...
                                        <ul class="slide-menu child2">
                                            ...
                                            <li class="slide">
                                                <a href="{{url('job-company-search')}}" class="side-menu__item">Job Search Company</a>
                                            </li>
                                            <li class="slide">
                                            ...
                                            <li class="slide">
                                                <a href="{{url('job-candidate-search')}}" class="side-menu__item">Job Candidate Search</a>
                                            </li>
                                            <li class="slide">
                                                <a href="{{url('job-candidate-details')}}" class="side-menu__item">Job Candidate Details</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="slide has-sub">
